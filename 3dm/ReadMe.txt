Quick overview:
Arap.py is a piece of code that deforms an object using 
ARAP algorithm.
Open the Demo gif to see the code in action.
To test out the code yourself read further.
...
11. You will probably get a file path error, because 
    "C:/Users/Jaswir Raghoe/Desktop/3dm/Arap.py"
